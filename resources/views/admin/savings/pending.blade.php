{{-- resources/views/admin/savings/pending.blade.php --}}
@extends('layouts.app')
...
@section('content')
    ...
    <div class="container mt-5">
        <h1 class="mb-4 text-center">Nasabah yang Belum Di-approve</h1>
        <div class="card">
            <div class="card-header">
                <h5 class="m-0">Daftar Nasabah Belum Di-approve</h5>
            </div>
            <div class="card-body">
