        ...
        @can('admin')
            ...
            <li>
                <a href="{{ route('umrah-packages.index') }}"
                    ...
                    <span class="links_name">Daftar Anggrek</span>
                </a>
            </li>
            <li>
                <a href="{{ route('package-variants.index') }}"
                    ...
                    <span class="links_name">Daftar Varian</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="{{ route('testimonials.index') }}"
                    ...
                    <span class="links_name">Daftar Testimoni</span>
                </a>
            </li>
            <li>
                <a href="{{ route('carousels.index') }}"
                    ...
                    <span class="links_name">Daftar Galeri</span>
                </a>
            </li>
            <li>
                <a href="{{ route('teams.index') }}" class="{{ request()->routeIs('teams.index') ? 'active' : '' }}">
                    <i class='bx bx-group'></i>
                    <span class="links_name">Daftar Admin</span>
                </a>
            </li>
            <li>
